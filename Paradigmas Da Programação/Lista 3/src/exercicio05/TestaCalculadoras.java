...
public class TestaCalculadoras {
    public static void main(String[] args) {
        ...
        // não precisou criar uma instancia da classe calculadora
        // pois calculadora cientifica ja herda os atributos

        //verificar se a questão ta pedindo obrigatoriamente
